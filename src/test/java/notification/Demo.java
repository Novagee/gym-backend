...
//      System.out.println(ret);
	...
	{
		XingeApp xinge = new XingeApp(2100037628, "3992c052c30b38b313a91ffc189ef8d8");
		Message message = new Message();
		message.setTitle("title");
		message.setContent("content");
		message.setType(Message.TYPE_MESSAGE);
		JSONObject ret = xinge.pushSingleDevice("1ebd44ec2d3552374f3f81e3f2338ba5fe836765", message);
	...
	{
		XingeApp xinge = new XingeApp(2100037628, "3992c052c30b38b313a91ffc189ef8d8");	
		JSONObject ret = xinge.pushSingleDevice("1ebd44ec2d3552374f3f81e3f2338ba5fe836765", message1);
		return (ret);
	}
