...
public enum UploadUtils {
	...
	public  String getAndroidAccessId(){
		return getProperties().getProperty("android.accessId");
	}
	
	public  String getAndroidAccessKey(){
		return getProperties().getProperty("android.accessKey");
	}
	
	public  String getAndroidSecretKey(){
		return getProperties().getProperty("android.secretKey");
	}
	...
	public String getUploadFileName(String id,String originalName){
		return new SimpleDateFormat("yyyyMMddHHmmssms").format(new Date())+"-"+id+"-"+originalName;
	}
	...
	public  String getUploadMockFilePath(){
		return getProperties().getProperty("mock.file.path");
	}
	
	public  String getUploadMockHttpPath(){
		return getProperties().getProperty("mock.http.path");
	}
